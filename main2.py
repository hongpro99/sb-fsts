...
# 종목 선택
trading_logic_options = ["check_wick", "penetrating"]

selected_trading_logic = st.sidebar.selectbox("select the trading logic:", trading_logic_options)
...
if st.sidebar.button("Run Simulation"):
    ...
    try:
        ...
        simulation_plot = auto_trading_stock.simulate_trading(
            ...
            trading_logic=selected_trading_logic
        )
        ...
        if result:
            ...
            st.dataframe(history_df_transposed)
        else:
