...
scheduler.add_job(auto_trading_scheduler.scheduled_trading_bnuazz15bot_task, 'cron', day_of_week='mon-fri', hour='14', minute='23') # 월~금 3시 10분에 실행
#scheduler.add_job(auto_trading_scheduler.scheduled_trading_weeklybot_task, 'cron', day_of_week='mon-fri', hour='15', minute='07')# 금 3시 10분에 실행(주봉)
