...
scheduler.add_job(auto_trading_scheduler.scheduled_trading_schedulerbot_task, 'cron', day_of_week='mon-fri', hour='15', minute='16')  # 월~금 3시 5분에 실행
...
scheduler.add_job(auto_trading_scheduler.scheduled_trading_bnuazz15_task, 'cron', day_of_week='mon-fri', hour='13', minute='50')
