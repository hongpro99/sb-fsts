...
scheduler.add_job(auto_trading_scheduler.scheduled_trading_task, 'cron', day_of_week='mon-fri', hour='14', minute='05')  # 월~금 10시 10분에 실행
...
async def trade():
    ...
    auto_trading_scheduler.scheduled_trading_task()
